...
const Navbar = () => {
  ...
  return (
    <nav
      className={`navbar bg-blue-light navbar-expand-lg p-0 rounded ${styles.navbarDashboard}`}
    >
      <div className="container">
        ...
        <button
          ...
          className="navbar-toggler shadow-none border border-0"
          type="button"
        ...
        >
          ...
          {isOpen && (
            <svg width="32" height="32" fill="#F00" viewBox="0 0 16 16">
              <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
            </svg>
          )}
        </button>
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className={`navbar-nav ${styles.navbarNavDashboardMobile}`}>
            <li className={`nav-item ${styles.navitemDashboard}`}>
              <NavLink
                to="/Dashboard"
                className={`nav-link fw-bold fs-4  ${styles.navlinkDashboard}`}
                href="/Doctor/Home"
              >
                <svg className="m-2" viewBox="0 0 16 16">
            ...
            <li className={`nav-item ${styles.navitemDashboard}`}>
              <NavLink
                to="/Dashboard/Files"
                className={`nav-link fw-bold fs-4  ${styles.navlinkDashboard} ${styles.navLink}`}
              >
                <svg className="m-2" viewBox="0 0 16 16">
            ...
            <li className={`nav-item ${styles.navitemDashboard}`}>
              ...
              >
                <svg className="m-2" viewBox="0 0 16 16">
                  <path d="M11.02 5.364a3 3 0 0 0-4.242-4.243L1.121 6.778a3 3 0 1 0 4.243 4.243l5.657-5.657Zm-6.413-.657 2.878-2.879a2 2 0 1 1 2.829 2.829L7.435 7.536 4.607 4.707ZM12 8a4 4 0 1 1 0 8 4 4 0 0 1 0-8Zm-.5 1.041a3 3 0 0 0 0 5.918V9.04Zm1 5.918a3 3 0 0 0 0-5.918v5.918Z"></path>
                </svg>
                الأدوية
              </NavLink>
            </li>
