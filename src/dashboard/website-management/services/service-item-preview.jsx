const ServiceItemPreview = ({ image, title, text }) => {
  return (
    <div className="bg-white position-relative  border-success border-opacity-50 rounded-3 p-1">
      {!image && (
        <svg width="250" height="208" x="0px" y="0px" viewBox="0 0 1000 1000">
      ...
      <h4 className="p-2 mb-0 text-start">{title || "إسم الخدمة"}</h4>
      <p className="p-1 mb-5 text-start">{text || "وصف الخدمة"}</p>
    </div>
  );
};
